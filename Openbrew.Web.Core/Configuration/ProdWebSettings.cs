...
namespace Openbrew.Web.Core.Configuration
{
	public class ProdWebSettings : AbstractWebSettings
	{
		...
		{
			get { return GetEnvironmentValue("OPENBREW_ROOT_URL_SECURE", "http://127.0.0.1:8085", "Brewgr_RootUrlSecure"); }
		}
		...
		{
			get { return GetEnvironmentValue("OPENBREW_STATIC_ROOT_URL", "http://127.0.0.1:8085", "Brewgr_StaticRootUrl"); }
		}
		...
		{
			get { return GetEnvironmentValue("OPENBREW_STATIC_ROOT_URL_SECURE", "http://127.0.0.1:8085", "Brewgr_StaticRootUrlSecure"); }
		}
